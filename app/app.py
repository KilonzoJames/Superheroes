...
def get_hero_by_id(id):
    ...
    for power in hero.powers:
        ...
        hero_dict['powers'].append(power_dict)  # Append power_dict to the powers list

    return jsonify(hero_dict)  # Return hero_dict as JSON

@app.route('/powers', methods=['GET'])
def powers():
    powers_list = []  # Use a different variable name to avoid conflicts
    for power in Power.query.all():
        ...
        powers_list.append(power_dict)  # Append power_dict to the powers_list
...
def fetch_power(id):
    ...
    return jsonify(power_dict)  # Return power_dict as JSON
